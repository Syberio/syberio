...
function App() {
  ...
  return (
    <ChakraProvider theme={theme}>
       <Box marginLeft='150px' marginTop='150px' position='absolute' fontSize='29px' color='rgb(71, 129, 200)' ><b>Generate Public and Private Keys</b></Box>
      ...
      <TabPanels marginLeft='100px' marginRight='200px'>
        ...
        <TabPanel marginTop='200px'>
            <Tabs>
              ...
              <TabPanels >
                <TabPanel onClick={()=>setkeyGenPlace("syberio")}>
                  <CreateKeys></CreateKeys>
                </TabPanel>
                <TabPanel onClick={()=>setkeyGenPlace("computer")}>
                  {/* <div className='A'>
                    <input type="text"
                    value={input}
                      ...
                      if(e.key === "Enter"){
                        ...
                        switch (input){
                          case "ls":
                            ...
                            break;
                          case "pwd":
                            newOutput +=" COOLEST PLACE ON THE WEB : SYBERIO";
                            break;
                          case "ssh-keygen":
                            newOutput +=" Enter file in which to save the key ()";
                            break;
                          case "/User/key":
                            newOutput +=" Enter passph";
                            break;
                          default:
