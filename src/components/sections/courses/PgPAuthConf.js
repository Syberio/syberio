...
const PgPAuthConf = () => {
  ...
  const items = [
    {
      ...
      description:
        " The Hash code of the function H is created using PGP) services.",
    },
    {
      id: 2,
      ...
      description:
        " Encrpyted hash code of the message is created using Public-Key Encryption EP",
    },
    {
      id: 3,
      code: "Concatanate",
      ...
      description:
        " The message M is concatanated with the hash code H using PGP Concatenation utility.",
    },
    {
      id: 4,
      code: "Zip",
    ...
    {
      id: 7,
      code: "Public-Key Encryption Algorithm",
  ...
  const itemsreciever = [
    ...
    {
      id: 13,
      code: "Public-Key Decryption Algorithm Private",
  ...
  return (
    ...
    <Box p={8}>
      <Heading as="h1" mb={8}>
        PGP Authentication & Confidentiality used together
      </Heading>
      <Box
        borderRadius="md"
        border="1px solid"
      ...
      >
        <VStack align="start" spacing={4} mb={8}>
          <Text fontSize="xl">
            How authentication and Confidentialitywork together
          </Text>
          <List spacing={4}>
            {items.map((item) => (
              <ListItem
          ...
          <Flex justify="center">
            ...
            <Container width="16%" h="600" borderRadius="md" borderColor="gray.200" bg="blue.500" border="1px solid black" marginLeft style=
              ...
              >
                ...
                <Flex style={{ position: 'absolute', top: "130px", left: "460px", transform: 'translate(-50%, -50%)' }}
                ...
                <Flex
                  style={{
                    ...
                    top: "260px",
                    left: "354px",
                    transform: "translate(-50%, -50%) scaleY(3.4)"
                  }}
                >
                  <Icon as={FaMinus} w="100px" h="10px" transform="rotate(90deg)" />
                </Flex>
